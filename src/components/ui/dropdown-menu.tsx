  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuGroup>
          <DropdownMenuItem onSelect={() => alert("selected profile")}>
            Profile
          </DropdownMenuItem>
          <DropdownMenuItem onSelect={() => alert("selected billing")}>
            Billing
          </DropdownMenuItem>
          <DropdownMenuItem onSelect={() => alert("selected settings")}>
            Settings
          </DropdownMenuItem>
        </DropdownMenuGroup>
        <DropdownMenuSeparator />
        <DropdownMenuItem disabled>No thing to do here</DropdownMenuItem>
        <DropdownMenuSeparator />
      </DropdownMenuContent>
    </DropdownMenu>
  );
